...
exports.benefitsGrants = benefitsGrants;
...
const benefitsgrants_js_1 = require("../models/operations/benefitsgrants.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(benefitsgrants_js_1.BenefitsGrantsRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/benefits/{id}/grants")(pathParams);
    ...
    const [result, raw] = await M.match(M.json(200, benefitsgrants_js_1.BenefitsGrantsResponse$inboundSchema, { key: "Result" }), M.jsonErr(404, resourcenotfound_js_1.ResourceNotFound$inboundSchema), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
