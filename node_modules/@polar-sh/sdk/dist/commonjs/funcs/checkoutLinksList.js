...
exports.checkoutLinksList = checkoutLinksList;
...
const checkoutlinkslist_js_1 = require("../models/operations/checkoutlinkslist.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(checkoutlinkslist_js_1.CheckoutLinksListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, checkoutlinkslist_js_1.CheckoutLinksListResponse$inboundSchema, { key: "Result" }), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
