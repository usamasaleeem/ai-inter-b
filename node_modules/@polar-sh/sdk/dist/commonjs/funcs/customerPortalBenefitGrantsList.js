...
exports.customerPortalBenefitGrantsList = customerPortalBenefitGrantsList;
...
const customerportalbenefitgrantslist_js_1 = require("../models/operations/customerportalbenefitgrantslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportalbenefitgrantslist_js_1.CustomerPortalBenefitGrantsListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/benefit-grants/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportalbenefitgrantslist_js_1.CustomerPortalBenefitGrantsListResponse$inboundSchema, {
        key: "Result",
