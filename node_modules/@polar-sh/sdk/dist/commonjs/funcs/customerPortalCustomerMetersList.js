...
exports.customerPortalCustomerMetersList = customerPortalCustomerMetersList;
...
const customerportalcustomermeterslist_js_1 = require("../models/operations/customerportalcustomermeterslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportalcustomermeterslist_js_1.CustomerPortalCustomerMetersListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/meters/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportalcustomermeterslist_js_1.CustomerPortalCustomerMetersListResponse$inboundSchema, {
        key: "Result",
