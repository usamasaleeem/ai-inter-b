...
exports.customerPortalCustomersListPaymentMethods = customerPortalCustomersListPaymentMethods;
...
const customerportalcustomerslistpaymentmethods_js_1 = require("../models/operations/customerportalcustomerslistpaymentmethods.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportalcustomerslistpaymentmethods_js_1.CustomerPortalCustomersListPaymentMethodsRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, customerportalcustomerslistpaymentmethods_js_1.CustomerPortalCustomersListPaymentMethodsResponse$inboundSchema, { key: "Result" }), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
