...
exports.customerPortalDownloadablesList = customerPortalDownloadablesList;
...
const customerportaldownloadableslist_js_1 = require("../models/operations/customerportaldownloadableslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportaldownloadableslist_js_1.CustomerPortalDownloadablesListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/downloadables/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportaldownloadableslist_js_1.CustomerPortalDownloadablesListResponse$inboundSchema, {
        key: "Result",
