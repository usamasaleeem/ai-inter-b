...
exports.customerPortalLicenseKeysList = customerPortalLicenseKeysList;
...
const customerportallicensekeyslist_js_1 = require("../models/operations/customerportallicensekeyslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportallicensekeyslist_js_1.CustomerPortalLicenseKeysListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/license-keys/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportallicensekeyslist_js_1.CustomerPortalLicenseKeysListResponse$inboundSchema, {
        key: "Result",
    }), M.jsonErr(401, unauthorized_js_1.Unauthorized$inboundSchema), M.jsonErr(404, resourcenotfound_js_1.ResourceNotFound$inboundSchema), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
