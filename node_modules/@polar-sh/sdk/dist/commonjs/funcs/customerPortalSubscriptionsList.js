...
exports.customerPortalSubscriptionsList = customerPortalSubscriptionsList;
...
const customerportalsubscriptionslist_js_1 = require("../models/operations/customerportalsubscriptionslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportalsubscriptionslist_js_1.CustomerPortalSubscriptionsListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/subscriptions/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportalsubscriptionslist_js_1.CustomerPortalSubscriptionsListResponse$inboundSchema, {
        key: "Result",
