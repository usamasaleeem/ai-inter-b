...
exports.customerPortalWalletsList = customerPortalWalletsList;
...
const customerportalwalletslist_js_1 = require("../models/operations/customerportalwalletslist.js");
...
async function $do(client, security, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customerportalwalletslist_js_1.CustomerPortalWalletsListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/customer-portal/wallets/")();
    ...
    const [result, raw] = await M.match(M.json(200, customerportalwalletslist_js_1.CustomerPortalWalletsListResponse$inboundSchema, {
        key: "Result",
...
//# sourceMappingURL=customerPortalWalletsList.js.map