...
const customersession_js_1 = require("../models/components/customersession.js");
const httpvalidationerror_js_1 = require("../models/errors/httpvalidationerror.js");
const customersessionscreate_js_1 = require("../models/operations/customersessionscreate.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customersessionscreate_js_1.CustomerSessionsCreateCustomerSessionCreate$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(201, customersession_js_1.CustomerSession$inboundSchema), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
