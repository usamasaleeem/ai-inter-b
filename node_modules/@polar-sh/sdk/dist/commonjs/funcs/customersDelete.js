...
exports.customersDelete = customersDelete;
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(customersdelete_js_1.CustomersDeleteRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
