...
exports.licenseKeysList = licenseKeysList;
...
const licensekeyslist_js_1 = require("../models/operations/licensekeyslist.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(licensekeyslist_js_1.LicenseKeysListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/license-keys/")();
    ...
    const [result, raw] = await M.match(M.json(200, licensekeyslist_js_1.LicenseKeysListResponse$inboundSchema, { key: "Result" }), M.jsonErr(401, unauthorized_js_1.Unauthorized$inboundSchema), M.jsonErr(404, resourcenotfound_js_1.ResourceNotFound$inboundSchema), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
