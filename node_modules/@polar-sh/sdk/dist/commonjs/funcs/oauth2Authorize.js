...
const oauth2authorize_js_1 = require("../models/operations/oauth2authorize.js");
...
async function $do(client, options) {
    const path = (0, url_js_1.pathToFunc)("/v1/oauth2/authorize")();
    ...
    const [result] = await M.match(M.json(200, oauth2authorize_js_1.Oauth2AuthorizeResponseOauth2Authorize$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
