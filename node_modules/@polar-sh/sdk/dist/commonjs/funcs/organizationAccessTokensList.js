...
exports.organizationAccessTokensList = organizationAccessTokensList;
...
const organizationaccesstokenslist_js_1 = require("../models/operations/organizationaccesstokenslist.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(organizationaccesstokenslist_js_1.OrganizationAccessTokensListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, organizationaccesstokenslist_js_1.OrganizationAccessTokensListResponse$inboundSchema, {
        key: "Result",
...
//# sourceMappingURL=organizationAccessTokensList.js.map