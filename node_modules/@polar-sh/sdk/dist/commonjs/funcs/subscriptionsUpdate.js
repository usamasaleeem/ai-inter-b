...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(subscriptionsupdate_js_1.SubscriptionsUpdateRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const doResult = await client._do(req, {
        context,
        errorCodes: ["402", "403", "404", "409", "422", "4XX", "5XX"],
    ...
    const [result] = await M.match(M.json(200, subscription_js_1.Subscription$inboundSchema), M.jsonErr(402, paymentfailed_js_1.PaymentFailed$inboundSchema), M.jsonErr(403, alreadycanceledsubscription_js_1.AlreadyCanceledSubscription$inboundSchema), M.jsonErr(404, resourcenotfound_js_1.ResourceNotFound$inboundSchema), M.jsonErr(409, subscriptionlocked_js_1.SubscriptionLocked$inboundSchema), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
