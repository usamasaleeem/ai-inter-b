...
exports.webhooksListWebhookDeliveries = webhooksListWebhookDeliveries;
...
const webhookslistwebhookdeliveries_js_1 = require("../models/operations/webhookslistwebhookdeliveries.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(webhookslistwebhookdeliveries_js_1.WebhooksListWebhookDeliveriesRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/webhooks/deliveries")();
    ...
    const [result, raw] = await M.match(M.json(200, webhookslistwebhookdeliveries_js_1.WebhooksListWebhookDeliveriesResponse$inboundSchema, {
        key: "Result",
