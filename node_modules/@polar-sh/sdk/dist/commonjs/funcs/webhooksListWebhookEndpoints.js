...
exports.webhooksListWebhookEndpoints = webhooksListWebhookEndpoints;
...
const webhookslistwebhookendpoints_js_1 = require("../models/operations/webhookslistwebhookendpoints.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(webhookslistwebhookendpoints_js_1.WebhooksListWebhookEndpointsRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, webhookslistwebhookendpoints_js_1.WebhooksListWebhookEndpointsResponse$inboundSchema, {
        key: "Result",
