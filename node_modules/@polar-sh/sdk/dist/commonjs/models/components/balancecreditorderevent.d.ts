...
import { BalanceCreditOrderMetadata } from "./balancecreditordermetadata.js";
import { Customer } from "./customer.js";
/**
 * An event created by Polar when an order is paid via customer balance.
 */
export type BalanceCreditOrderEvent = {
    /**
...
/** @internal */
export declare const BalanceCreditOrderEvent$inboundSchema: z.ZodMiniType<BalanceCreditOrderEvent, unknown>;
export declare function balanceCreditOrderEventFromJSON(jsonString: string): SafeParseResult<BalanceCreditOrderEvent, SDKValidationError>;
//# sourceMappingURL=balancecreditorderevent.d.ts.map