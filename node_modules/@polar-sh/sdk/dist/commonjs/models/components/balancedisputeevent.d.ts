 ...
 */
export type BalanceDisputeEvent = {
    /**
...
/** @internal */
export declare const BalanceDisputeEvent$inboundSchema: z.ZodMiniType<BalanceDisputeEvent, unknown>;
export declare function balanceDisputeEventFromJSON(jsonString: string): SafeParseResult<BalanceDisputeEvent, SDKValidationError>;
//# sourceMappingURL=balancedisputeevent.d.ts.map