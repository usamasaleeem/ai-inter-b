...
import { BalanceRefundMetadata } from "./balancerefundmetadata.js";
import { Customer } from "./customer.js";
/**
 * An event created by Polar when a refund is reverted.
 */
export type BalanceRefundReversalEvent = {
    /**
...
/** @internal */
export declare const BalanceRefundReversalEvent$inboundSchema: z.ZodMiniType<BalanceRefundReversalEvent, unknown>;
export declare function balanceRefundReversalEventFromJSON(jsonString: string): SafeParseResult<BalanceRefundReversalEvent, SDKValidationError>;
//# sourceMappingURL=balancerefundreversalevent.d.ts.map