...
exports.Benefit$outboundSchema = exports.Benefit$inboundSchema = void 0;
exports.benefitToJSON = benefitToJSON;
exports.benefitFromJSON = benefitFromJSON;
...
exports.Benefit$inboundSchema = z.union([
    ...
    benefitfeatureflag_js_1.BenefitFeatureFlag$inboundSchema,
    ...
    benefitmetercredit_js_1.BenefitMeterCredit$inboundSchema,
]);
/** @internal */
exports.Benefit$outboundSchema = z.union([
    ...
    benefitfeatureflag_js_1.BenefitFeatureFlag$outboundSchema,
    ...
    benefitmetercredit_js_1.BenefitMeterCredit$outboundSchema,
]);
function benefitToJSON(benefit) {
    return JSON.stringify(exports.Benefit$outboundSchema.parse(benefit));
}
function benefitFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.Benefit$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Benefit' from JSON`);
}
