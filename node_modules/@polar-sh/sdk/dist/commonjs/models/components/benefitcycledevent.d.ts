...
/** @internal */
export declare const BenefitCycledEvent$inboundSchema: z.ZodMiniType<BenefitCycledEvent, unknown>;
export declare function benefitCycledEventFromJSON(jsonString: string): SafeParseResult<BenefitCycledEvent, SDKValidationError>;
//# sourceMappingURL=benefitcycledevent.d.ts.map