...
import { CheckoutCreatedMetadata } from "./checkoutcreatedmetadata.js";
import { Customer } from "./customer.js";
/**
 * An event created by Polar when a checkout is created.
 */
export type CheckoutCreatedEvent = {
    /**
...
/** @internal */
export declare const CheckoutCreatedEvent$inboundSchema: z.ZodMiniType<CheckoutCreatedEvent, unknown>;
export declare function checkoutCreatedEventFromJSON(jsonString: string): SafeParseResult<CheckoutCreatedEvent, SDKValidationError>;
//# sourceMappingURL=checkoutcreatedevent.d.ts.map