...
export type CheckoutLinkCreateProductsMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CheckoutLinkCreateProductsMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CheckoutLinkCreateProductsMetadata$outboundSchema: z.ZodMiniType<CheckoutLinkCreateProductsMetadata$Outbound, CheckoutLinkCreateProductsMetadata>;
...
/** @internal */
export declare const CheckoutLinkCreateProducts$outboundSchema: z.ZodMiniType<CheckoutLinkCreateProducts$Outbound, CheckoutLinkCreateProducts>;
