...
exports.CheckoutPublic$inboundSchema = exports.CheckoutPublicDiscount$inboundSchema = exports.CheckoutPublicPrices$inboundSchema = exports.CheckoutPublicProductPrice$inboundSchema = exports.CheckoutPublicCustomFieldData$inboundSchema = void 0;
...
exports.checkoutPublicPricesFromJSON = checkoutPublicPricesFromJSON;
...
const checkoutorganization_js_1 = require("./checkoutorganization.js");
...
/** @internal */
exports.CheckoutPublicCustomFieldData$inboundSchema = (0, smartUnion_js_1.smartUnion)([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
exports.CheckoutPublicProductPrice$inboundSchema = (0, smartUnion_js_1.smartUnion)([
...
/** @internal */
exports.CheckoutPublicPrices$inboundSchema = (0, smartUnion_js_1.smartUnion)([
    legacyrecurringproductprice_js_1.LegacyRecurringProductPrice$inboundSchema,
    productprice_js_1.ProductPrice$inboundSchema,
]);
function checkoutPublicPricesFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.CheckoutPublicPrices$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CheckoutPublicPrices' from JSON`);
}
/** @internal */
exports.CheckoutPublicDiscount$inboundSchema = (0, smartUnion_js_1.smartUnion)([
...
/** @internal */
exports.CheckoutPublic$inboundSchema = z.pipe(z.object({
    id: z.string(),
    ...
    custom_field_data: z.optional(z.record(z.string(), z.nullable((0, smartUnion_js_1.smartUnion)([
        z.string(),
        z.int(),
        z.boolean(),
        z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v))),
    ...
    active_trial_interval: z.nullable(trialinterval_js_1.TrialInterval$inboundSchema),
    ...
    product: z.nullable(checkoutproduct_js_1.CheckoutProduct$inboundSchema),
    product_price: z.nullable((0, smartUnion_js_1.smartUnion)([
        legacyrecurringproductprice_js_1.LegacyRecurringProductPrice$inboundSchema,
        productprice_js_1.ProductPrice$inboundSchema,
    ])),
    prices: z.nullable(z.record(z.string(), z.array((0, smartUnion_js_1.smartUnion)([
        legacyrecurringproductprice_js_1.LegacyRecurringProductPrice$inboundSchema,
        productprice_js_1.ProductPrice$inboundSchema,
    ])))),
    discount: z.nullable((0, smartUnion_js_1.smartUnion)([
        checkoutdiscountfixedrepeatduration_js_1.CheckoutDiscountFixedRepeatDuration$inboundSchema,
        checkoutdiscountfixedonceforeverduration_js_1.CheckoutDiscountFixedOnceForeverDuration$inboundSchema,
        checkoutdiscountpercentagerepeatduration_js_1.CheckoutDiscountPercentageRepeatDuration$inboundSchema,
        checkoutdiscountpercentageonceforeverduration_js_1.CheckoutDiscountPercentageOnceForeverDuration$inboundSchema,
    ])),
    organization: checkoutorganization_js_1.CheckoutOrganization$inboundSchema,
    attached_custom_fields: z.nullable(z.array(attachedcustomfield_js_1.AttachedCustomField$inboundSchema)),
}), z.transform((v) => {
