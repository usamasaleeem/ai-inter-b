...
exports.CustomerSubscription$inboundSchema = exports.CustomerSubscriptionPrices$inboundSchema = void 0;
...
const pendingsubscriptionupdate_js_1 = require("./pendingsubscriptionupdate.js");
...
/** @internal */
exports.CustomerSubscriptionPrices$inboundSchema = (0, smartUnion_js_1.smartUnion)([
...
/** @internal */
exports.CustomerSubscription$inboundSchema = z.pipe(z.object({
    ...
    canceled_at: z.nullable(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    started_at: z.nullable(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    ends_at: z.nullable(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    ended_at: z.nullable(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    ...
    pending_update: z.nullable(pendingsubscriptionupdate_js_1.PendingSubscriptionUpdate$inboundSchema),
}), z.transform((v) => {
