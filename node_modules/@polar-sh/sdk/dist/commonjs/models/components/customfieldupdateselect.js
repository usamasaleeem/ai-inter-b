...
exports.CustomFieldUpdateSelect$outboundSchema = exports.CustomFieldUpdateSelectMetadata$outboundSchema = void 0;
...
/** @internal */
exports.CustomFieldUpdateSelectMetadata$outboundSchema = (0, smartUnion_js_1.smartUnion)([z.string(), z.int(), z.number(), z.boolean()]);
...
exports.CustomFieldUpdateSelect$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(customfieldselectproperties_js_1.CustomFieldSelectProperties$outboundSchema)),
});
