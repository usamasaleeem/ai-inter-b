...
exports.CustomFieldUpdateText$outboundSchema = exports.CustomFieldUpdateTextMetadata$outboundSchema = void 0;
...
/** @internal */
exports.CustomFieldUpdateTextMetadata$outboundSchema = (0, smartUnion_js_1.smartUnion)([z.string(), z.int(), z.number(), z.boolean()]);
...
exports.CustomFieldUpdateText$outboundSchema = z.object({
    ...
    type: z.literal("text"),
    properties: z.optional(z.nullable(customfieldtextproperties_js_1.CustomFieldTextProperties$outboundSchema)),
});
