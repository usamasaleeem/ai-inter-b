...
exports.FilterClause$outboundSchema = exports.FilterClause$inboundSchema = exports.Value$outboundSchema = exports.Value$inboundSchema = void 0;
...
/** @internal */
exports.Value$inboundSchema = (0, smartUnion_js_1.smartUnion)([
    z.string(),
    z.int(),
    z.boolean(),
]);
/** @internal */
exports.Value$outboundSchema = (0, smartUnion_js_1.smartUnion)([z.string(), z.int(), z.boolean()]);
...
exports.FilterClause$inboundSchema = z.object({
    ...
    value: (0, smartUnion_js_1.smartUnion)([z.string(), z.int(), z.boolean()]),
});
/** @internal */
