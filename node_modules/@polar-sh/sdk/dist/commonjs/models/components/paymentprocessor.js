...
exports.PaymentProcessor$outboundSchema = exports.PaymentProcessor$inboundSchema = exports.PaymentProcessor = void 0;
const z = __importStar(require("zod/v4-mini"));
exports.PaymentProcessor = {
    Stripe: "stripe",
};
/** @internal */
exports.PaymentProcessor$inboundSchema = z.enum(exports.PaymentProcessor);
/** @internal */
