...
export declare const Scope: {
    ...
    readonly WalletsWrite: "wallets:write";
    ...
    readonly MemberSessionsWrite: "member_sessions:write";
    readonly CustomerSeatsRead: "customer_seats:read";
    readonly CustomerSeatsWrite: "customer_seats:write";
    ...
    readonly MetricsWrite: "metrics:write";
    ...
    readonly OrganizationAccessTokensRead: "organization_access_tokens:read";
    readonly OrganizationAccessTokensWrite: "organization_access_tokens:write";
};
export type Scope = OpenEnum<typeof Scope>;
/** @internal */
export declare const Scope$inboundSchema: z.ZodMiniType<Scope, unknown>;
