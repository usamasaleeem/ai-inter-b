...
import { SubscriptionUncanceledMetadata } from "./subscriptionuncanceledmetadata.js";
/**
 * An event created by Polar when a subscription cancellation is reversed.
 */
export type SubscriptionUncanceledEvent = {
    /**
...
/** @internal */
export declare const SubscriptionUncanceledEvent$inboundSchema: z.ZodMiniType<SubscriptionUncanceledEvent, unknown>;
export declare function subscriptionUncanceledEventFromJSON(jsonString: string): SafeParseResult<SubscriptionUncanceledEvent, SDKValidationError>;
//# sourceMappingURL=subscriptionuncanceledevent.d.ts.map