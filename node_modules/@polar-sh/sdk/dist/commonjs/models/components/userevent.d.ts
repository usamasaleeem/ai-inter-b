...
import { EventMetadataOutput } from "./eventmetadataoutput.js";
/**
...
export type UserEvent = {
    ...
    source: "user";
    metadata: {
        [k: string]: EventMetadataOutput;
    };
};
/** @internal */
export declare const UserEvent$inboundSchema: z.ZodMiniType<UserEvent, unknown>;
