...
exports.UserEvent$inboundSchema = void 0;
...
const eventmetadataoutput_js_1 = require("./eventmetadataoutput.js");
/** @internal */
exports.UserEvent$inboundSchema = z
    .pipe(z.object({
    id: z.string(),
    ...
    metadata: z.record(z.string(), eventmetadataoutput_js_1.EventMetadataOutput$inboundSchema),
}), z.transform((v) => {
...
function userEventFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.UserEvent$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'UserEvent' from JSON`);
}
