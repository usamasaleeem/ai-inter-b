...
exports.NotPermitted$inboundSchema = exports.NotPermitted = void 0;
const z = __importStar(require("zod/v4-mini"));
const polarerror_js_1 = require("./polarerror.js");
class NotPermitted extends polarerror_js_1.PolarError {
...
/** @internal */
exports.NotPermitted$inboundSchema = z.pipe(z.object({
