...
exports.OrderNotEligibleForRetry$inboundSchema = exports.OrderNotEligibleForRetry = void 0;
const z = __importStar(require("zod/v4-mini"));
const polarerror_js_1 = require("./polarerror.js");
class OrderNotEligibleForRetry extends polarerror_js_1.PolarError {
...
exports.OrderNotEligibleForRetry = OrderNotEligibleForRetry;
/** @internal */
exports.OrderNotEligibleForRetry$inboundSchema = z.pipe(z.object({
