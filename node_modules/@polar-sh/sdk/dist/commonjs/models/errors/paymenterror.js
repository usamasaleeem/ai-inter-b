...
exports.PaymentError$inboundSchema = exports.PaymentError = void 0;
const z = __importStar(require("zod/v4-mini"));
const polarerror_js_1 = require("./polarerror.js");
class PaymentError extends polarerror_js_1.PolarError {
...
/** @internal */
exports.PaymentError$inboundSchema = z.pipe(z.object({
