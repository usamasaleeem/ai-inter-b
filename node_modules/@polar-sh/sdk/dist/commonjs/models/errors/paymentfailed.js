...
exports.PaymentFailed$inboundSchema = exports.PaymentFailed = void 0;
const z = __importStar(require("zod/v4-mini"));
const polarerror_js_1 = require("./polarerror.js");
class PaymentFailed extends polarerror_js_1.PolarError {
...
/** @internal */
exports.PaymentFailed$inboundSchema = z.pipe(z.object({
