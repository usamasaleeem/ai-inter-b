...
const webhookbenefitgrantcycledpayload_js_1 = require("./models/components/webhookbenefitgrantcycledpayload.js");
...
const webhookcustomerseatassignedpayload_js_1 = require("./models/components/webhookcustomerseatassignedpayload.js");
const webhookcustomerseatclaimedpayload_js_1 = require("./models/components/webhookcustomerseatclaimedpayload.js");
const webhookcustomerseatrevokedpayload_js_1 = require("./models/components/webhookcustomerseatrevokedpayload.js");
const webhookmembercreatedpayload_js_1 = require("./models/components/webhookmembercreatedpayload.js");
const webhookmemberupdatedpayload_js_1 = require("./models/components/webhookmemberupdatedpayload.js");
const webhookmemberdeletedpayload_js_1 = require("./models/components/webhookmemberdeletedpayload.js");
const webhookcheckoutexpiredpayload_js_1 = require("./models/components/webhookcheckoutexpiredpayload.js");
const webhooksubscriptionpastduepayload_js_1 = require("./models/components/webhooksubscriptionpastduepayload.js");
    ...
    try {
        switch (parsed.type) {
            ...
            case "customer_seat.assigned":
                return webhookcustomerseatassignedpayload_js_1.WebhookCustomerSeatAssignedPayload$inboundSchema.parse(parsed);
            case "customer_seat.claimed":
                return webhookcustomerseatclaimedpayload_js_1.WebhookCustomerSeatClaimedPayload$inboundSchema.parse(parsed);
            case "customer_seat.revoked":
                return webhookcustomerseatrevokedpayload_js_1.WebhookCustomerSeatRevokedPayload$inboundSchema.parse(parsed);
            case "member.created":
                return webhookmembercreatedpayload_js_1.WebhookMemberCreatedPayload$inboundSchema.parse(parsed);
            case "member.updated":
                return webhookmemberupdatedpayload_js_1.WebhookMemberUpdatedPayload$inboundSchema.parse(parsed);
            case "member.deleted":
                return webhookmemberdeletedpayload_js_1.WebhookMemberDeletedPayload$inboundSchema.parse(parsed);
            ...
            case "benefit_grant.cycled":
                return webhookbenefitgrantcycledpayload_js_1.WebhookBenefitGrantCycledPayload$inboundSchema.parse(parsed);
            ...
            case "checkout.expired":
                return webhookcheckoutexpiredpayload_js_1.WebhookCheckoutExpiredPayload$inboundSchema.parse(parsed);
            case "order.created":
            ...
            case "subscription.past_due":
                return webhooksubscriptionpastduepayload_js_1.WebhookSubscriptionPastDuePayload$inboundSchema.parse(parsed);
            default:
