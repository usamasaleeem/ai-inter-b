...
import { PortalAuthenticatedUser$inboundSchema, } from "../models/components/portalauthenticateduser.js";
 ...
 */
export function customerPortalCustomerSessionGetAuthenticatedUser(client, security, options) {
...
async function $do(client, security, options) {
    ...
    const [result] = await M.match(M.json(200, PortalAuthenticatedUser$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
