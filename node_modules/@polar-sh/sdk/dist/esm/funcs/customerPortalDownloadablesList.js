...
import { CustomerPortalDownloadablesListRequest$outboundSchema, CustomerPortalDownloadablesListResponse$inboundSchema, } from "../models/operations/customerportaldownloadableslist.js";
 ...
 */
export function customerPortalDownloadablesList(client, security, request, options) {
    return new APIPromise($do(client, security, request, options));
}
async function $do(client, security, request, options) {
    const parsed = safeParse(request, (value) => z.parse(CustomerPortalDownloadablesListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, CustomerPortalDownloadablesListResponse$inboundSchema, {
        key: "Result",
