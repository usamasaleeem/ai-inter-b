...
/** @internal */
export const AddressCountryAlpha2$inboundSchema = openEnums.inboundSchema(AddressCountryAlpha2);
/** @internal */
export const AddressCountryAlpha2$outboundSchema = openEnums.outboundSchema(AddressCountryAlpha2);
/** @internal */
export const Address$inboundSchema = z.pipe(z.object({
...
/** @internal */
export const Address$outboundSchema = z.pipe(z.object({
    line1: z.optional(z.nullable(z.string())),
    line2: z.optional(z.nullable(z.string())),
