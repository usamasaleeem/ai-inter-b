...
/** @internal */
export const BalanceOrderMetadata$inboundSchema = z.pipe(z.object({
...
export function balanceOrderMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BalanceOrderMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BalanceOrderMetadata' from JSON`);
}
