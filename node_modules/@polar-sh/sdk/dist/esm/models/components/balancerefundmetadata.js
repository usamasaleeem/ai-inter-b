...
/** @internal */
export const BalanceRefundMetadata$inboundSchema = z.pipe(z.object({
...
export function balanceRefundMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BalanceRefundMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BalanceRefundMetadata' from JSON`);
}
//# sourceMappingURL=balancerefundmetadata.js.map