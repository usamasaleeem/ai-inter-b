...
import { BenefitGrantMetadata$inboundSchema, } from "./benefitgrantmetadata.js";
import { Customer$inboundSchema } from "./customer.js";
/** @internal */
export const BenefitUpdatedEvent$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
export function benefitUpdatedEventFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitUpdatedEvent$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitUpdatedEvent' from JSON`);
}
