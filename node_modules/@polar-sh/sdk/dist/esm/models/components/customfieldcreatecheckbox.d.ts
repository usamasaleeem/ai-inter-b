...
export type CustomFieldCreateCheckboxMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldCreateCheckboxMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const CustomFieldCreateCheckboxMetadata$outboundSchema: z.ZodMiniType<CustomFieldCreateCheckboxMetadata$Outbound, CustomFieldCreateCheckboxMetadata>;
...
/** @internal */
export declare const CustomFieldCreateCheckbox$outboundSchema: z.ZodMiniType<CustomFieldCreateCheckbox$Outbound, CustomFieldCreateCheckbox>;
