...
/** @internal */
export const Meta$inboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.number(),
    z.boolean(),
...
/** @internal */
export const LicenseKeyActivationBase$inboundSchema = z.pipe(z.object({
    id: z.string(),
    license_key_id: z.string(),
    label: z.string(),
    meta: z.record(z.string(), smartUnion([z.string(), z.int(), z.number(), z.boolean()])),
