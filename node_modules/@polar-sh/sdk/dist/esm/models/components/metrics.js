...
/** @internal */
export const Metrics$inboundSchema = z.pipe(z.object({
    ...
    committed_monthly_recurring_revenue: z.optional(z.nullable(Metric$inboundSchema)),
    ...
    renewed_subscriptions_net_revenue: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_customer_service: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_low_quality: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_missing_features: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_switched_service: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_too_complex: z.optional(z.nullable(Metric$inboundSchema)),
    canceled_subscriptions_too_expensive: z.optional(z.nullable(Metric$inboundSchema)),
