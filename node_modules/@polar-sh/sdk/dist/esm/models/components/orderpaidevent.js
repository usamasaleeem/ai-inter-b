...
import { OrderPaidMetadata$inboundSchema, } from "./orderpaidmetadata.js";
/** @internal */
export const OrderPaidEvent$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
export function orderPaidEventFromJSON(jsonString) {
    return safeParse(jsonString, (x) => OrderPaidEvent$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OrderPaidEvent' from JSON`);
}
