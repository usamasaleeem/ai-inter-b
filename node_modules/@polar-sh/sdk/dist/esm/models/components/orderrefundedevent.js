...
import { OrderRefundedMetadata$inboundSchema, } from "./orderrefundedmetadata.js";
/** @internal */
export const OrderRefundedEvent$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
export function orderRefundedEventFromJSON(jsonString) {
    return safeParse(jsonString, (x) => OrderRefundedEvent$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OrderRefundedEvent' from JSON`);
}
