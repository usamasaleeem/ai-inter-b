...
export declare const CountryAlpha2: {
    readonly Ad: "AD";
    readonly Ae: "AE";
    readonly Af: "AF";
    readonly Ag: "AG";
...
/** @internal */
export declare const CountryAlpha2$inboundSchema: z.ZodMiniType<CountryAlpha2, unknown>;
/** @internal */
export declare const CountryAlpha2$outboundSchema: z.ZodMiniType<string, CountryAlpha2>;
/** @internal */
export declare const Organization$inboundSchema: z.ZodMiniType<Organization, unknown>;
/** @internal */
...
/** @internal */
export declare const Organization$outboundSchema: z.ZodMiniType<Organization$Outbound, Organization>;
