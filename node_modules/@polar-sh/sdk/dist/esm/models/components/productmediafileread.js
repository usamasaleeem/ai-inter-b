...
/** @internal */
export const ProductMediaFileRead$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
/** @internal */
export const ProductMediaFileRead$outboundSchema = z.pipe(z.object({
    id: z.string(),
...
export function productMediaFileReadToJSON(productMediaFileRead) {
    return JSON.stringify(ProductMediaFileRead$outboundSchema.parse(productMediaFileRead));
}
export function productMediaFileReadFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ProductMediaFileRead$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductMediaFileRead' from JSON`);
}
