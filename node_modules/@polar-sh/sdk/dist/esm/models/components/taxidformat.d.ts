...
/** @internal */
export declare const TaxIDFormat$inboundSchema: z.ZodMiniType<TaxIDFormat, unknown>;
/** @internal */
export declare const TaxIDFormat$outboundSchema: z.ZodMiniType<string, TaxIDFormat>;
