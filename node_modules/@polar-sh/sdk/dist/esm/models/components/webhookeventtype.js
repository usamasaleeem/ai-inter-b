...
/** @internal */
export const WebhookEventType$inboundSchema = openEnums.inboundSchema(WebhookEventType);
/** @internal */
export const WebhookEventType$outboundSchema = openEnums.outboundSchema(WebhookEventType);
