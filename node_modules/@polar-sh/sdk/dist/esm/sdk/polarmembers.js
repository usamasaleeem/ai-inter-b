...
export class PolarMembers extends ClientSDK {
    ...
    async listMembers(request, options) {
        return unwrapResultIterator(customerPortalMembersListMembers(this, request, options));
    }
    /**
     * Add Member
     *
    ...
    async addMember(request, options) {
        return unwrapAsync(customerPortalMembersAddMember(this, request, options));
    }
    /**
     * Remove Member
     *
     ...
     */
    async removeMember(request, options) {
        return unwrapAsync(customerPortalMembersRemoveMember(this, request, options));
    }
    /**
     * Update Member
     *
    ...
    async updateMember(request, options) {
        return unwrapAsync(customerPortalMembersUpdateMember(this, request, options));
    }
}
//# sourceMappingURL=polarmembers.js.map