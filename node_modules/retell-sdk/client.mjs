...
var _Retell_instances, _a, _Retell_encoder, _Retell_baseURLOverridden;
...
import * as Webhooks from "./lib/webhook_auth.mjs";
...
import { ChatAgent, } from "./resources/chat-agent.mjs";
import { Concurrency } from "./resources/concurrency.mjs";
import { ConversationFlow, } from "./resources/conversation-flow.mjs";
import { ConversationFlowComponent, } from "./resources/conversation-flow-component.mjs";
...
import { Tests, } from "./resources/tests.mjs";
...
export class Retell {
    ...
    constructor({ baseURL = readEnv('RETELL_BASE_URL'), apiKey, ...opts }) {
        ...
        __classPrivateFieldSet(this, _Retell_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Retell_instances, "m", _Retell_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Retell_encoder, "f").call(this, { body, headers });
        }
    }
}
_a = Retell, _Retell_encoder = new WeakMap(), _Retell_instances = new WeakSet(), _Retell_baseURLOverridden = function _Retell_baseURLOverridden() {
