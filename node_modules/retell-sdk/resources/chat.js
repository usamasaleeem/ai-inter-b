...
class Chat extends resource_1.APIResource {
    ...
    retrieve(chatID, options) {
        return this._client.get((0, path_1.path) `/get-chat/${chatID}`, options);
    }
    /**
    ...
    update(chatID, body, options) {
        return this._client.patch((0, path_1.path) `/update-chat/${chatID}`, { body, ...options });
    }
    /**
     * List all chats
     *
     ...
     */
        ...
        return this._client.patch((0, path_1.path) `/end-chat/${chatID}`, {
            ...options,
