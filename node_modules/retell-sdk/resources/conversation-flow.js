...
exports.ConversationFlow = void 0;
const resource_1 = require("../core/resource.js");
const headers_1 = require("../internal/headers.js");
const path_1 = require("../internal/utils/path.js");
class ConversationFlow extends resource_1.APIResource {
    /**
    ...
    retrieve(conversationFlowID, query = {}, options) {
        return this._client.get((0, path_1.path) `/get-conversation-flow/${conversationFlowID}`, { query, ...options });
    }
    /**
    ...
    update(conversationFlowID, params, options) {
        ...
        return this._client.patch((0, path_1.path) `/update-conversation-flow/${conversationFlowID}`, {
            query: { version },
            body,
            ...options,
        });
    ...
    delete(conversationFlowID, options) {
        return this._client.delete((0, path_1.path) `/delete-conversation-flow/${conversationFlowID}`, {
            ...options,
